...
def ode_c(self,c,u,psi,nx,phi=1):
    """
...
def ode_tau(self,tau,c,u,interp_k,nx):
    """
...
def alg_u(self,u,interp_k_inv,tau,l):
...
def alg_psi(self,psi,u,interp_k_inv,interp_j,tau):
    """ Function that defines the algebraic equations of u.
