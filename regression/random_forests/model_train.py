...
def train_model(output,data):
    ...
    # Save the model
    # --------------
    output_name_save = output.replace(' ', '_').lower()

    save_model(model_regression, f'regression/models/{output_name_save}/model_{output_name_save}.pkl')
    save_model((X_test, y_test), f'regression/models/{output_name_save}/test_data_.pkl')
    save_model((X_train, y_train), f'regression/models/{output_name_save}/train_data.pkl')
