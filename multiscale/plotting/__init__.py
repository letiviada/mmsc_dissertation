...
from .plots_data_ml import scatter_histogram, boxplot, view_data_all_outputs,scatter_solutions
...
from .plots_varying_alpha_beta import plot_adhesivity, plot_perf_ind
from .plots_optimization import plot_time_opt, plot_one_weight, plot_for_spec_throughput, plot_for_varying_beta, plot_range_time